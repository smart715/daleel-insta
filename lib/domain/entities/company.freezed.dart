    ...
    return _then(_value.copyWith(
      ...
      shortDescription: shortDescription == freezed
          ...
          : shortDescription // ignore: cast_nullable_to_non_nullable
              as String?,
      websiteLink: websiteLink == freezed
          ? _value.websiteLink
          : websiteLink // ignore: cast_nullable_to_non_nullable
              as String?,
      officeHours: officeHours == freezed
          ? _value.officeHours
...
class _$_Company extends _Company {
  ...
  @override
  String toString() {
    return 'Company(businessId: $businessId, customerId: $customerId, locationId: $locationId, categoryId: $categoryId, packageId: $packageId, name: $name, email: $email, address: $address, contactNumber: $contactNumber, shortDescription: $shortDescription, websiteLink: $websiteLink, officeHours: $officeHours, instagramLink: $instagramLink, twitterLink: $twitterLink, facebookLink: $facebookLink, youtubeLink: $youtubeLink, telegramLink: $telegramLink, paymentStatus: $paymentStatus, image: $image)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.websiteLink, websiteLink) &&
            const DeepCollectionEquality()
                .equals(other.officeHours, officeHours) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hashAll([
        ...
        const DeepCollectionEquality().hash(officeHours),
