...
class ReviewAndRatingCard extends StatelessWidget {
  const ReviewAndRatingCard({Key? key, required this.title, required this.date, required this.time, required this.description, required this.imagePath, required this.rating, required this.onTap}) : super(key: key);
