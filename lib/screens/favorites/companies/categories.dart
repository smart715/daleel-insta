...
import 'package:insta_daleel/screens/favorites/companies/companies.dart';
          ...
          SearchWidget(
            onChanged: (searchedText) {
              ...
              if (searchedText.isNotEmpty) {
                for (var item
                    in AllCategoryBehavior.allCategoryResponseDataBackupList) {
                ...
                AllCategoryBehavior.allCategoryResponseDataFilteredList.addAll(
                    AllCategoryBehavior.allCategoryResponseDataBackupList);
                setState(() {});
              }
            },
                          ...
                          onTap: () {
                            String id = AllCategoryBehavior
                                ...
                                ? AllCategoryBehavior
                                    ...
                                    : '---'
                                : '---';
                            String name = AllCategoryBehavior
                                        .allCategoryResponseDataFilteredList[
                                    index] is Map<String, dynamic>
                                ? AllCategoryBehavior
                                            .allCategoryResponseDataFilteredList[
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ShowCategoriesCompanies(
                                        id: id,
                                        name: name,
                                      )),
                            );
