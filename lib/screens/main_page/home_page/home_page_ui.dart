...
class HomePageProfilePic extends ConsumerStatefulWidget {
  const HomePageProfilePic({Key? key}) : super(key: key);

  static VoidCallback setStateHomePageProfilePic = () {};

  @override
  ConsumerState<HomePageProfilePic> createState() => _HomePageProfilePicState();
}

class _HomePageProfilePicState extends ConsumerState<HomePageProfilePic> {
